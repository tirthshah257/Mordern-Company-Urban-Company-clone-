        ...
        <div class="row">
          <div class="col-12 col-md-6 order-1 order-md-0 align-self-md-end">
            <div class="row py-3 py-sm-5 py-xl-9 bsb-section-mt-md-1 justify-content-sm-center">
              <div class="col-12 col-sm-10">
                <h1 class="display-2 fw-bolder mb-4 text-white">Welcome {{session()->get('first_name')}}</h1>
                <div class="row">
                  <div class="col-12 col-xxl-8">
                    <p class="fs-5 mb-5 text-secondary">We work in a customized way by devising and handling entirely online projects with long-term partnerships.</p>
                  </div>
                </div>
                <div class="d-grid gap-2 d-sm-flex">
                  <button type="button" class="btn btn-accent bsb-btn-2xl rounded-pill"><a href="/services" style="color:whitesmoke;text-decoration: none;">Explore Now</a></button>
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 p-0">
            <figure class="bsb-overlay-figure w-100 h-100 m-0" style="--bsb-overlay-figure-opacity: .3">
              <img class="img-fluid w-100 h-100 object-fit-cover" loading="lazy" src="./User_assets/img/hero/hero-img-1.webp" alt="">
            </figure>
          </div>
        </div>
      </div>
  ...
  <main id="main">
          ...
          <div class="col-12 col-md-4">
            <div class="card bsb-tpl-bg-lotion bsb-tpl-border-lg-cyan">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="mb-4 text-secondary">We can help you to drive organic traffic and outrank competitors with our SEO strategies for your content.</p>
                <a href="#!" class="fw-bold text-decoration-none link-primary">
                  Learn More
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
          ...
          <div class="col-12 col-md-4">
            <div class="card bsb-tpl-bg-lotion bsb-tpl-border-lg-cyan">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="mb-4 text-secondary">We offer 24/7 support. This means that you can always get help when you need it, no matter what time it is.</p>
                <a href="#!" class="fw-bold text-decoration-none link-primary">
                  Learn More
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
    ...
    <section class="bg-primary" data-bs-theme="dark">
      <div class="container-fluid overflow-hidden">
        <div class="row">
          <div class="col-12 col-md-6 p-0">
            <img class="img-fluid w-100 h-100 object-fit-cover" loading="lazy" src="./User_assets/img/about/about-img-1.webp" alt="">
          </div>
          <div class="col-12 col-md-6 align-self-md-end">
            <div class="row py-3 py-sm-5 py-xxl-9 bsb-section-mt-md-1 justify-content-sm-center">
              <div class="col-12 col-sm-10">
                <h2 class="display-4 fw-bold mb-4">Who Are We?</h2>
                <p class="fs-5 mb-5 text-secondary">We help people to build incredible brands and superior products. Our perspective is to furnish outstanding captivating services.</p>
                <div class="row">
                  <div class="col-12 col-xl-9 col-xxl-7">
                    <div class="d-flex mb-5">
                      <div class="me-4 text-accent">
                      ...
                      <div>
                        <h4 class="fw-bold mb-3">Versatile Brand</h4>
                    ...
                    <div class="d-flex">
                      ...
                      <div>
                        <h4 class="fw-bold mb-3">Digital Agency</h4>
                        <p class="mb-0">We believe in innovation by integrating primary with elaborate ideas.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row gy-4 gy-md-0 gx-xxl-5">
          <div class="col-12 col-md-4">
            <div class="card bsb-tpl-bg-lotion bsb-tpl-border-lg-cyan">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./User_assets/img/testimonial/testimonial-img-1.jpg" alt="Luna John">
                  <figcaption>
          ...
          <div class="col-12 col-md-4">
            <div class="card bsb-tpl-bg-lotion bsb-tpl-border-lg-cyan">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./User_assets/img/testimonial/testimonial-img-2.jpg" alt="Mark Smith">
                  <figcaption>
          ...
          <div class="col-12 col-md-4">
            <div class="card bsb-tpl-bg-lotion bsb-tpl-border-lg-cyan">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./User_assets/img/testimonial/testimonial-img-4.jpg" alt="Luke Reeves">
                  <figcaption>
                    <div class="bsb-ratings text-primary mb-3" data-bsb-star="5" data-bsb-star-off="0"></div>
          ...
          <div class="col-12 col-md-6 order-1 order-md-0 align-self-md-end">
            <div class="row py-3 py-sm-5 py-xxl-9 bsb-section-mt-md-1 justify-content-sm-center">
              <div class="col-12 col-sm-10">
                ...
                <button type="button" class="btn bsb-btn-2xl btn-accent rounded-pill">Connect Now</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 p-0">
            <img class="img-fluid w-100 h-100 object-fit-cover" loading="lazy" src="./User_assets/img/about/about-img-2.webp" alt="">
          </div>
        </div>
      </div>
    </section>
            ...
            <article>
              <div class="card border-0">
                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./User_assets/img/blog/blog-image-1.jpg" alt="Business">
                  </a>
                  <figcaption>
          ...
          <div class="col-12 col-lg-4">
            <article>
              <div class="card border-0">
                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./User_assets/img/blog/blog-image-2.jpg" alt="Nutrition">
                  </a>
                  <figcaption>
          ...
          <div class="col-12 col-lg-4">
            <article>
              <div class="card border-0">
                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./User_assets/img/blog/blog-image-3.jpg" alt="Health">
                  </a>
                  <figcaption>
    ...
    <section class="bg-primary" data-bs-theme="dark">
      <div class="container-fluid overflow-hidden">
        <div class="row">
          <div class="col-12 col-md-6 p-0">
            <img class="img-fluid w-100 h-100 object-fit-cover" loading="lazy" src="./User_assets/img/process/process-img-1.webp" alt="">
          </div>
          <div class="col-12 col-md-6 align-self-md-end">
            <div class="row py-3 py-sm-5 py-xxl-9 bsb-section-mt-md-1 justify-content-sm-center">
              <div class="col-12 col-sm-10">
                <h2 class="display-4 fw-bold mb-4">Our Design Process</h2>
                <p class="fs-5 mb-5 text-secondary">Our design approach is very organized to ensure satisfaction for our esteemed clients.</p>
                <div class="d-flex mb-4">
                  <div>
                    <span class="btn btn-accent bsb-btn-circle pe-none me-4">1</span>
                  </div>
                  <div>
                    <h4 class="fw-bold mb-3">Planning</h4>
                    <p class="mb-0">Get to know your users and their needs better through surveys, interviews, usability testing, and other methods.</p>
                  </div>
                </div>
                <div class="d-flex mb-4">
                  <div>
                    <span class="btn btn-accent bsb-btn-circle pe-none me-4">2</span>
                  </div>
                  <div>
                    <h4 class="fw-bold mb-3">Launch</h4>
                    <p class="mb-0">This involves creating wireframes, mockups, and prototypes to test out your ideas and get feedback from users.</p>
                  </div>
                </div>
                <div class="d-flex">
                  <div>
                    <span class="btn btn-accent bsb-btn-circle pe-none me-4">3</span>
                  </div>
                  <div>
                    <h4 class="fw-bold mb-3">Finalize Product</h4>
                    <p class="mb-0">Once your product is launched, it's important to gather feedback from users to learn what they like and dislike about it.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="py-5 py-xl-8 bsb-section-py-xxl-1">
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h3 class="fs-6 text-secondary mb-2 text-uppercase">Our Clients</h3>
            <h2 class="display-4 fw-bold mb-0">Trusted by over 786+ esteemed clients</h2>
          </div>
        </div>
      </div>
            ...
            <div class="row h-100 align-items-end justify-content-center">
              <div class="col-12 col-md-11 col-xl-10">
                <div class="footer-logo-wrapper">
                  <a href="index.html">
                    <img src="./User_assets/img/branding/palette-logo.svg" alt="" width="179" height="60">
                  </a>
                </div>
