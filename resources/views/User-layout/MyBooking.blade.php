    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{ route('User-layout.updateBooking', ['id' => $booking->booking_id]) }}" method="post">
                    @csrf
                    <input type="hidden" name="booking_Id" id="booking_Id">
                    <div class="form-floating mb-3">
                        <select class="form-select" name="service_id" id="userType" required>
                        <option value="{{$booking->booking_id}}">Select Service</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" id="booking_time" name="booking_time" value="{{ $booking->booking_time }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="payment_mode" class="form-label">Payment Mode</label>
                        <input type="text" class="form-control" id="payment_mode" name="payment_mode" value="{{ $booking->payment_mode }}" required >
                    </div>
